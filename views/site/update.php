    ...
    <div class="panel panel-default">
        ...
        <div id="collapseThree_inner" class="panel-collapse collapse">
            <div class="panel-body">
                ...
                6)Было добавлено поле ввода "Подтвержения пароля" для формы регистрации.<br>
                ...
                2)Было добавлено поле phone, в котором хранится номере телефона пользователя.<br>
                ...
                2)В модели таблицы "accounts" было добавлено провило о запрете возврата пароля и "ключа доступа" в формы авторизации и регистрации.<br>
